    ...
    return (
        <>
            <PageHeader
                ...
                breadcrumb={<><Link to="/" className="text-white text-decoration-none">Home</Link><span className="mx-2">/</span><span>Gallery</span></>}
            />
                        ...
                        <div className="d-flex flex-wrap gap-2">
                            {categories.map((cat) => (
                                <button
                                    ...
                                    className={`btn btn-sm px-3 py-2 rounded-pill fw-semibold transition-all ${activeCategory === cat
