                    ...
                    <div className="container">
                        <div className="row g-3 text-center text-md-start align-items-center">
                            ...
                            <div className="col-md-4 text-md-end">
                                <a href="/admission/landing" className="btn btn-light text-primary fw-bold btn-sm px-4 rounded-pill shadow-sm">
                        ...
                        <div className="row g-5">
                            ...
                            <div className="col-lg-5">
                                ...
                                <div id="apply-now" className="card border-0 shadow rounded-4 p-4 bg-dark text-white text-center">
                                    ...
                                    <a href="/admission/landing" className="btn btn-warning fw-bold text-dark py-2 rounded-3 shadow-sm">
                                        Apply Online Now
                                    </a>
